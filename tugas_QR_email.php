...
?>
<div class="col-sm-6">
<h2>QR Code Generator<h1>16N10010 Send To Email</h1></h2>
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  Email: <input type="email" name="email" class="form-control" value="<?php echo $email;?>">
  <?php echo $emailErr;?></span>
  <br><br>
  Subject: <input type="text" name="sub" class="form-control" value="<?php echo $sub;?>">
  <?php echo $subErr;?></span>
  <br><br>
  Body: <input type="text" name="bod" class="form-control" value="<?php echo $bod;?>">
